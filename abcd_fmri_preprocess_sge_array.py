...
# This script will submit a workflow_cluster.sh job using SGE array job
#
#
# command code to run in a cluster environment
# source activate /cbica/projects/ABCD_PreProc/.conda/envs/abcd
# python /cbica/projects/ABCD_PreProc/rsfmri/Script/abcd_fmri_preprocess_sge_array.py
